...
#            self.status_line.configure(text="Now docking ligand: %s...." % ligands)
    ...
    def load_dlg(self, filename):
        ...
        pose_list.sort(key = lambda x: x.energy) # lambda a, b: cmp(a.energy, b.energy)
...
#            print model.energy
    ...
    def update_combo(self, name):
        ...
        pose_list.sort(key = lambda x: int(x.split('::')[1]))
...
#           cmd.delete(pmlname+'.*')
    ...
    def sort_complete_ligand_list(self):
        self.all_ligands.sort(key = lambda x: x.energy) # lambda a, b: cmp(a.energy, b.energy)
